(function() {
  ...
  module.exports = function(options) {
    var AtomicIndex, AtomicRecord, FDBoost, Index, KeyFrag, SerializerFactory, activeIndexes, database, dataset, db, fdb, fields, index, indexName, indexes, keyFrag, partition, primaryKey, save, transactionalIndex, transactionalSave;
    if (!options) {
