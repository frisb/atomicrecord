...
module.exports = function(options) {
  var AtomicIndex, AtomicRecord, Index, KeyFrag, SerializerFactory, activeIndexes, database, dataset, db, fdb, fields, index, indexName, indexes, keyFrag, partition, primaryKey, remove, save, transactionalIndex, transactionalRemove, transactionalSave;
  if (!options) {
  ...
  return AtomicRecord = (function(_super) {
    ...
    AtomicRecord.prototype.serialize = function(callback) {
      ...
      if (this.aliasMap[keyFrag.idName] && !this[keyFrag.idName]) {
