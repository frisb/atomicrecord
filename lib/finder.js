(function() {
  ...
  module.exports = function(query, options) {
    var ActiveRecordPrototype, Finder;
    if (options == null) {
      options = {};
    }
    ActiveRecordPrototype = this;
    Finder = (function(_super) {
      ...
      Finder.prototype.assembled = [];

      Finder.prototype.currentRecord = null;

      Finder.prototype.key = null;
      ...
      Finder.prototype.toArray = function(iterator, callback) {
        return iterator.toArray((function(_this) {
          return function(err, arr) {
            ActiveRecordPrototype.deserialize(_this.directory, arr);
      ...
      Finder.prototype.execute = function(tr, iteratorType) {
        ...
        return ActiveRecordPrototype.directoryResolver.resolve(query, callback);
      };
